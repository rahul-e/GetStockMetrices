...
datapath = 'F:\\Projects\\Stocks\\StockAnalysis\\'
print(datapath)
...
# Get ticker labels from user-input file ticker.txt
ticker = pd.read_table(datapath+'ticker.txt',header=0)
ticker = ticker['Ticker-Symbol'].T
